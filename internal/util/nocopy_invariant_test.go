...
var reviewedInPlaceByteWrites = map[string]reviewedInPlaceByteWrite{
	...
	"internal/runtime/executor/claude_executor_request.go":  {3, "shifts []string headers to insert credential-required beta parts; no byte of any payload is rewritten"},
