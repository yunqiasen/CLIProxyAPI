...
func resolveNativeAPIKeyConfigByAuth[T internalconfig.NativeAPIKeyConfigEntry](entries []T, auth *Auth) *T {
	if auth == nil || len(entries) == 0 {
		return nil
	}
	...
	entry, _ := internalconfig.ResolveNativeAPIKeyConfig(entries, apiKey, baseURL)
	return entry
}
...
func resolveGeminiAPIKeyConfig(cfg *internalconfig.Config, auth *Auth) *internalconfig.GeminiKey {
	...
	return resolveNativeAPIKeyConfigByAuth(cfg.GeminiKey, auth)
}
...
func resolveInteractionsAPIKeyConfig(cfg *internalconfig.Config, auth *Auth) *internalconfig.GeminiKey {
	...
	return resolveNativeAPIKeyConfigByAuth(cfg.InteractionsKey, auth)
}
...
func resolveClaudeAPIKeyConfig(cfg *internalconfig.Config, auth *Auth) *internalconfig.ClaudeKey {
	...
	return resolveNativeAPIKeyConfigByAuth(cfg.ClaudeKey, auth)
}
...
func resolveCodexAPIKeyConfig(cfg *internalconfig.Config, auth *Auth) *internalconfig.CodexKey {
	...
	return resolveNativeAPIKeyConfigByAuth(cfg.CodexKey, auth)
}
...
func resolveXAIAPIKeyConfig(cfg *internalconfig.Config, auth *Auth) *internalconfig.XAIKey {
	...
	return resolveNativeAPIKeyConfigByAuth(cfg.XAIKey, auth)
}
